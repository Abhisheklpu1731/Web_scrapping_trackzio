...
The pipeline follows four clearly defined stages:

1. Data collection from a public source  
2. Data cleaning and normalization  
3. Attribute enrichment  
4. Final dataset packaging  
...
1. OpenGraph metadata (`og:description`)
2. Structured data embedded in JSON-LD
3. Fallback to visible content when available
...
The cleaning stage prepares scraped data for structured and consistent use.
...
**Text Cleanup**  
Removes excess whitespace and discards uninformative or extremely short descriptions.

**Price Parsing**  
Converts price strings into numeric values where possible.  
Listings marked as POA are treated as missing values.
...
- A single confidence score per item (0–1) reflecting overall certainty
